...
class Evaluator:
    def __init__(self, args):
        ...
        self.doctor_names = ["GPT-4"] #args.doctor_names
    ...
    def build_onestep_platform(self):
        ...
        for doctor_name, doctor_diagnosis_filepath in [
            ...
            ("GPT-4", "D:\\HuaweiMoveData\\Users\\王翔\\Desktop\\AI_Hospital-main\\dialog_history_ds_max_v3_noRL_eye.jsonl"),
            # ('Qwen-max', 'D:\\HuaweiMoveData\\Users\\王翔\\Desktop\\AI_Hospital-main\\src\\outputs\\test\\dialog_history_qwen_max_RL_test_1.jsonl'),
            # ('Qwen-max-base', 'D:\\HuaweiMoveData\\Users\\王翔\\Desktop\\AI_Hospital-main\\src\\outputs\\test\\dialog_history_qwen_max_base.jsonl')
                ]:
    ...
    def evaluate(self):
        # determine whether the patient has been processed
        print(self.doctor_names)
        # print(self.doctor_name_to_diagnosis)
        doctor_name_to_processed_patient_ids = {}
        if os.path.exists(self.eval_save_filepath):
            with jsonlines.open(self.eval_save_filepath, "r") as fr:
                for obj in fr:
...
def get_args():
    ...
    parser.add_argument("--evaluation_platform", type=str, default="dialog", help="platform for evaluation")
    parser.add_argument("--eval_save_filepath", type=str, default="D:\\HuaweiMoveData\\Users\\王翔\\Desktop\\AI_Hospital-main\\new_eval\\dialog_history_ds_max_v3_noRL_eye_eval.jsonl", help="save path for evaluation results")
    ...
    return args
    #evaluation_platform:choice = ["onestep", "dialog", "collaborative_discussion"]

if __name__ == "__main__":
    args = get_args()
    evaluator = Evaluator(args)
    print(args.evaluation_platform)
    ...
    if args.evaluation_platform == "collaborative_discussion":
        ...
        print(1)
        evaluator.build_dialog_platform()#build_onestep_platform()
    else:
