...
class QwenDoctor(Doctor):
    ...
    def add_parser_args(parser):
        ...
        parser.add_argument(
            ...
            choices=["deepseek-v3", "qwen-max", "qwen-max-0125", "qwen-max-1201", "qwen-plus-gamma", "qwen-plus", "qwen-turbo", "baichuan2-7b-chat-v1", "baichuan2-13b-chat-v1"], default="qwen-max")
